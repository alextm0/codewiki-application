  ...
  const ProblemSetRow = problemSet.map((problem) => {
    return (
      <tr class="bg-gray-50 border-b">
        <th
          scope="row"
          class="py-4 px-6 mt-[6px] font-medium flex items-center gap-5 text-gray-900 whitespace-nowrap "
        >
        ...
        <td class="py-4 px-6 text-gray-600">{problem.tags}</td>
        ...
        {!(
          ...
          <td class="py-4 px-6 text-2xl text-gray-600"></td>
        )}
      </tr>
    );
  });
        ...
        <table class="w-full text-sm text-left text-gray-500 ">
          <thead class="text-xs font-medium text-gray-700 uppercase bg-gray-50 ">
            <tr>
              <th
                scope="col"
                class="py-3 px-6 font-medium text-violet-100 bg-[#5363B7] border-b-[1px] border-gray-300"
              >
                Source
              </th>
              <th
              ...
              <th
                scope="col"
                class=" font-medium text-violet-100 bg-[#5363B7] border-b-[1px] border-gray-300"
              ></th>
            </tr>
          </thead>
