...
import AdmitereIcon from "../../public/assets/icons/admitere-icon.svg";
import BacalaureatIcon from "../../public/assets/icons/bacalaureat-icon.svg";
import OlimpiadaIcon from "../../public/assets/icons/olimpiada-icon.svg";
      ...
      <div className="mb-20">
        <div className="container px-4 lg:px-8 mx-auto max-w-screen-xl text-gray-700 ">
          <div className="grid md:grid-cols-3 gap-14 md:gap-5 mt-32">
            ...
            >
              <div className="bg-orange-500 rounded-full w-16 h-16 flex items-center justify-center mx-auto shadow-lg transform -translate-y-12">
                <Image src={OlimpiadaIcon} alt="" className="w-10 mt-[2px]" />
              </div>
